...
class ConnectedToBlinqStateWidget extends StatelessWidget {
  //
  const ConnectedToBlinqStateWidget({super.key});
      ...
      children: [
        ...
        Row(
          ...
          children: [
            MyButton.tertiary(
              width: 136,
              label: 'strDisconnect'.tr(),
              onTap: () => cubit.disconnect(false),
