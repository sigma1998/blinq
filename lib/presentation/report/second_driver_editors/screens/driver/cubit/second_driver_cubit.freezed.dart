...
class _$SecondDriverStateImpl implements _SecondDriverState {
  const _$SecondDriverStateImpl({this.status = Status.initial, this.error});
  ...
  @override
  String toString() {
    return 'SecondDriverState(status: $status, error: $error)';
  }
...
abstract class _SecondDriverState implements SecondDriverState {
  const factory _SecondDriverState({final Status status, final Error? error}) =
      _$SecondDriverStateImpl;
