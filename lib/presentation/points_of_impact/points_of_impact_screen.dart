...
import 'package:blinq/presentation/points_of_impact/bloc/points_of_impact_bloc.dart';
...
class PointsOfImpactScreen extends StatelessWidget {
  ...
  PointsOfImpactScreen({Key? key}) : super(key: key);

  final PointsOfImpactBloc bloc = PointsOfImpactBloc();
                          ...
                          Row(
                            ...
                            children: [
                              ArrowButtonWidget(
                                  ...
                                  onTap: () => bloc.onArrowPressed(
                                      pointOfImpact: PointOfImpact.bottomLeft),
                              ...
                              ArrowButtonWidget(
                                  color: state.isBottomRightActive
                                      ...
                                      : null,
                                  onTap: () => bloc.onArrowPressed(
                                      pointOfImpact: PointOfImpact.bottomRight),
...
class PointsOfImpactScreenArgs {}
